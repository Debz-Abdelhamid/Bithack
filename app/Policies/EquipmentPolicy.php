...
class EquipmentPolicy
{
    ...
    /**
     * Printing the physical QR label (and marking it printed) is an
     * operational A3 task — its own permission so it can be delegated
     * from the Shield UI without granting write access.
     */
    public function printLabel(AuthUser $authUser, Equipment $equipment): bool
    {
        return $authUser->can('PrintLabel:Equipment');
    }
}
