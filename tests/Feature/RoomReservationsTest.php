...
it('generates one row per week for a recurring timetable slot, sharing a group id', function (): void {
    $teacher = reservationTeacher();
    ...
    Livewire::test(CreateRoomReservation::class)
        ->fillForm([
            ...
            'end_at' => $this->nextMonday->copy()->addMinutes(90),
            'repeat_weekly' => true,
            'repeat_until' => $this->nextMonday->copy()->addWeeks(3)->toDateString(),
        ])
        ->call('create')
        ->assertHasNoFormErrors();
