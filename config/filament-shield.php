...
return [
    ...
    */
    ...
    'super_admin' => [
        'enabled' => true,
        'name' => 'super_admin',
        // Gate-based super admin: full access via Gate::before, no permission
        // rows needed (robust across fresh DBs/tests) — Security.md §3.
    ...
    */
    ...
    // Disabled: the role set is locked to the six business roles + super_admin
    // (Security.md §3) — no auto-created extra roles.
    'panel_user' => [
        'enabled' => false,
        'name' => 'panel_user',
    ],
